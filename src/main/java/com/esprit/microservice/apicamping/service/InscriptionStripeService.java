...
import com.esprit.microservice.apicamping.config.StripeProperties;
...
public class InscriptionStripeService {
    ...
    public Session createCheckoutSession(InscriptionSite inscriptionSite) {
        ...
        try {
            ...
            BigDecimal totalAmount = BigDecimal.valueOf(inscriptionSite.getSiteCamping().getPrixParNuit())
                    .multiply(BigDecimal.valueOf(numberOfNights))
                    .multiply(BigDecimal.valueOf(inscriptionSite.getNumberOfGuests()));

            SessionCreateParams params = SessionCreateParams.builder()
                    .setMode(SessionCreateParams.Mode.PAYMENT)
                    .setClientReferenceId(String.valueOf(inscriptionSite.getIdInscription()))
                    .setCustomerEmail(inscriptionSite.getUtilisateurEmail())
                    ...
                    .putMetadata("userId", String.valueOf(inscriptionSite.getUtilisateurId()))
                    .addLineItem(
